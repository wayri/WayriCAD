...
class ProtocolConstraintComposerPlugin(pcbnew.ActionPlugin):
    def defaults(self):self.name="WayriCAD Constraint Studio";self.category="Design Rules";self.description="Detect protocol nets and compose reviewed KiCad custom design rules.";self.show_toolbar_button=True;self.icon_file_name=os.path.join(os.path.dirname(__file__),"resources","icon-24.png");self.dark_icon_file_name=self.icon_file_name.replace("icon-24.png", "icon-dark-24.png");self.version="3.2.1"
    def Run(self):
