...
SPECS = {
    ...
    "fanout_generator_plugin": ("Fanout Generator", ("Configure", "Preview", "Commit"), ("Footprint: U7", "Pattern: BGA/LGA Grid Escape", "Width: 0.20 mm   Length: 1.50 mm"), ("Footprint", "Pad", "Net", "Result"), (("U7", "A1", "DDR_DQ0", "Track + via"), ("U7", "A2", "DDR_DQ1", "Track + via")), "Preview on PCB", "Commit to PCB"),
    ...
    "via_stitching_plugin": ("Via Stitching", ("Configure", "Preview", "Commit"), ("Net: GND", "Spacing: 2.50 mm   Edge inset: 1.00 mm", "Area and exclusions: optional"), ("#", "Net", "X (mm)", "Y (mm)"), (("1", "GND", "12.500", "8.000"), ("2", "GND", "15.000", "8.000")), "Preview on PCB", "Commit to PCB"),
}
...
def render(package: str, spec: tuple) -> None:
    title, steps, controls, columns, rows, primary, commit = spec
    ...
    for row_index, row in enumerate(rows):
        ...
        for index, value in enumerate(row):
            ...
            text(draw, (x + 9, y + 10), value, 15)
    button(draw, (700, 544, 880, 592), primary, primary=True)
    button(draw, (896, 544, 1068, 592), commit)
    ...
    callout(draw, 3, (835, 622), (790, 568), "Primary action")
