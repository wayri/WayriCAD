...
SPECS = {
    ...
    "signal_integrity_advisor_plugin/test_points": ("Test Point Descriptor Extractor", ("Configure", "Review preview", "Export"), ("Descriptor field: TP_Descriptor", "Board order: DEMO_CTRL, DEMO_SENSOR, DEMO_POWER, DEMO_IO"), ("TP", "Net", "Type", "Destination"), (("TP10", "SPI_CLK", "TD", "DEMO_SENSOR"), ("TP11", "RESET_N", "CD", "DEMO_POWER")), "Extract Preview", "Export..."),
