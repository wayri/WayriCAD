...
class PluginUI(wx.Dialog):
    ...
    def _build_ui(self) -> None:
        ...
        self.schematic_dir = wx.TextCtrl(config.GetStaticBox())
        browse_btn = wx.Button(config.GetStaticBox(), label="Browse")
        browse_btn.Bind(wx.EVT_BUTTON, self.on_browse_dir)
        self.board_sequence = wx.TextCtrl(config.GetStaticBox())
        self.board_sequence.SetToolTip("Comma-separated board order, e.g. DEMO_CTRL, DEMO_SENSOR, DEMO_POWER, DEMO_IO")
        self.pass_field = wx.TextCtrl(config.GetStaticBox())
        self.pass_field.SetValue("NetTie_Path")
        analyze_btn = wx.Button(config.GetStaticBox(), label="Analyze & Preview")
        analyze_btn.Bind(wx.EVT_BUTTON, self.on_analyze)
        analyze_btn.SetDefault()

        source_row = wx.BoxSizer(wx.HORIZONTAL)
        source_row.Add(wx.StaticText(config.GetStaticBox(), label="Netlist directory:"), 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 4)
        ...
        options_row.Add(wx.StaticText(config.GetStaticBox(), label="Board order:"), 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 4)
        options_row.Add(self.board_sequence, 1, wx.EXPAND | wx.ALL, 4)
        options_row.Add(wx.StaticText(config.GetStaticBox(), label="Pass field:"), 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 4)
        ...
        self.cross_rules = wx.TextCtrl(cross_rules_box.GetStaticBox(), size=(-1, 72), style=wx.TE_MULTILINE | wx.TE_DONTWRAP)
        ...
        component_controls.Add(wx.StaticText(component_controls.GetStaticBox(), label="Reference pattern:"), 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 4)
        self.component_pattern = wx.TextCtrl(component_controls.GetStaticBox(), value="J*", size=(130, -1))
        ...
        select_refresh = wx.Button(component_controls.GetStaticBox(), label="Use PCB Selection")
        select_refresh.Bind(wx.EVT_BUTTON, self.on_refresh_component_selection)
        component_controls.Add(select_refresh, 0, wx.ALL, 4)
        preview_components = wx.Button(component_controls.GetStaticBox(), label="Preview")
        ...
        flow_controls.Add(wx.StaticText(flow_controls.GetStaticBox(), label="Sources:"), 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 4)
        self.flow_source_filter = wx.TextCtrl(flow_controls.GetStaticBox(), value="J*,U*", size=(110, -1))
        ...
        flow_controls.Add(wx.StaticText(flow_controls.GetStaticBox(), label="Destinations:"), 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 4)
        self.flow_destination_filter = wx.TextCtrl(flow_controls.GetStaticBox(), value="U*,J*", size=(110, -1))
        ...
        self.flow_include_intermediates = wx.CheckBox(flow_controls.GetStaticBox(), label="Show pass-through parts")
        ...
        self.flow_include_power = wx.CheckBox(flow_controls.GetStaticBox(), label="Include power")
        flow_controls.Add(self.flow_include_power, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 4)
        flow_preview_btn = wx.Button(flow_controls.GetStaticBox(), label="Preview Flow")
