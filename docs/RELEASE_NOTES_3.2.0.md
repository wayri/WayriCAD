...
- **BOM component insights:** passive/active and RLC breakdowns, cost/mass/power distributions, and saved-board courtyard/pad-area coverage. Power-density summaries use only components with both declared power and supported geometry; missing geometry stays unknown. These summaries are not thermal simulations.
