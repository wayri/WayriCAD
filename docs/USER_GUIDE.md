...
This guide describes the current 20-tool suite. Screenshots are captures of the applications using example or Marble projects; their values are examples, not predictions for your board. Individual tool guides explain additional controls.
...
| [Quick PI](../quick_pi_plugin/README.md) | Net, source/sink pads, voltage/current | Read-only layered DC mesh, fields, losses and risk screening; export reports |
...
| [Quick SI](../signal_integrity_advisor_plugin/ReadMe.md) | Signal path, stackup and driver/load assumptions | Read-only delay/reflection/termination screening; not a full channel solver |
...
| [Copper Balancer](../copper_balancer_plugin/README.md) | Saved board, region and density settings | Preview copper thieving and save an explicit board copy |
| [Mechanical Check](../mechanical_check_plugin/README.md) | Saved board, component models and enclosure | Clearance/interference evidence; exact-solid checks require FreeCAD |
...
| [PDN Decoupling](../pdn_decoupling_plugin/ReadMe.md) | Power nets, components and design assumptions | Decoupling placement review; does not replace the PI solve |
...
| [Return-Path Auditor](../return_path_auditor_plugin/ReadMe.md) | Signal paths and reference layers | Review transitions/discontinuities and unresolved return geometry |
| [Test Point Descriptor](../test_point_descriptor_plugin/ReadMe.md) | Test-point/connector selection and fixture requirements | Test-point documentation and fixture outputs |
| [Variant Workbench](../variant_workbench_plugin/README.md) | Saved design and population/variant definition | Review and generate variants in project copies |
...
BOM Studio's primary workflow is **open the project → review component fields → stage edits → export a purchasing or assembly table**. Native KiCad BOM settings can be inherited; advanced catalogue, variant and automation tools are optional. Save a workspace to retain the staged review. Exporting a BOM and applying native schematic edits are different operations.
